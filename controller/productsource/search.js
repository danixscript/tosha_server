...
const searchProductSource = async (req, res, next) => {
    try {
       
       
        let getAllProductSources = await productsource.selectProductLike(req.query.id,req.query.text);
...
module.exports.searchProductSource = searchProductSource;