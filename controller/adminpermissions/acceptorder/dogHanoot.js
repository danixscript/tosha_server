...
const dogHanoot = async (req, res, next) => {
    
    try {

        let allProviders = await DohSQL.selectAllOrders()
...
if(allProviders[0].length > 0){
  ...
  const path = "../tosha_server/public/upload";
        ...
        worksheet.getRow(1).eachCell((cell) => {
          ...
          const data = await workbook.xlsx.writeFile(`${path}/store.xlsx`)
...
module.exports.dogHanoot = dogHanoot;