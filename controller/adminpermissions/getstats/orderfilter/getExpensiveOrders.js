...
const getExpensiveOrders = async (req, res, next) => {
    try {
        let getAllOrdersNow = await adminorders.getExpensiveProducts();
...
module.exports.getExpensiveOrders = getExpensiveOrders;