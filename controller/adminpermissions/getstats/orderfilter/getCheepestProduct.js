...
const getCheepestProduct = async (req, res, next) => {
    try {
        let getAllOrdersNow = await adminorders.getCheepestProducts();
...
module.exports.getCheepestProduct = getCheepestProduct;